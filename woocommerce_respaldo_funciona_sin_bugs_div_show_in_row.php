      ...
      <div class="modal-body row" id="showDetails">
        <div id="productInfo row">
        	<div style="display:flex;">
        		...
        		<i id="i-cerrarDetalles" class="fa fa-times" aria-hidden="true" style="font-size: 32px;"></i>
        	</div>
...
console.log("Antes de agregar el div, esto trae el show details del modal: "+$(divModal).find("#showDetails").html());
					...
					$("#productInfoH2").text($("#contenedorProductos").find("h1.product_title").text());
...
$("#agregar > a").click(function(e){
	...
	e.preventDefault();
	$("#divPopUp > .div-detalle").find("button.single_add_to_cart_button").click();
	console.log("se encontro el boton");
	
});

$("div#cantidad > input").change(function(){
	$("#divPopUp > .div-detalle").find("div.quantity > input").val($(this).val()).change();
